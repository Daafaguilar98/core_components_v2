<template>
  ...
  >
    <!-- <ko-order1/> -->
    <div class="container">
      <div class="content-header" :style="`background-color:${setting.styleObject.colorNav}`">
        <div class="container-nav">
          ...
          <div class="wrapper" v-else>
            <div @click="mouseOver" class="name" :style="`color:${setting.styleObject.colorText}`">
              <p>Ingresar</p>
              <i class="el-icon-arrow-down"></i>
            </div>
          ...
          <div class="content-icon-cart" :style="`color:${setting.styleObject.colorText}`">
            <i class="icon-user" @click="mouseOver"></i>
            <el-badge :value="productsCart" class="item">
              <i class="icon-shopping-cart" @click="openOrder"></i>
            </el-badge>
          </div>
        </div>
      </div>
    ...
    <transition name="fade">
      <div class="back" v-if="popover" @click="mouseOver"></div>
    </transition>
