<template>
  <div class="product_list1">
    <paginate name="products" :list="products" :per="40" tag="div" class="product_list">
      <div
        :is="selectedCard"
    ...
    <paginate-links v-if="products.length > 41" for="products" :show-step-links="true" :limit="5"></paginate-links>
  </div>
</template>
