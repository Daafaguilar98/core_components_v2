  ...
  <footer>
    <div class="footer_content">
      <div class="footer_info">
        ...
        <p v-for="address in addresses" v-show="address.direccion">
    ...
    <div class="footer_last">
      ...
      <p class="text powered_by">
        Desarrollado por
        <a href="https://komercia.co" target="_blank">komercia.co</a>
      </p>
      <img
        src="http://res.cloudinary.com/komercia-store/image/upload/v1536178935/komercia/logo.png"
      >
    </div>
  </footer>
</template>
